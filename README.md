...
- **Модуль 01 / Module 01**
  - Базовый Python / Basic Python - *Project_1_1*
  - Предобработка данных / Processing - *Project_1_2*
  - Исследовательский анализ данных / Exploratory data analysis - *Project_1_3*
  - Статистический анализ данных / Statistical analysis - *Project_1_4*
  - Сборный проект / General project - *Project_1_5*
- **Модуль 02 / Module 02**  
...
На данных Яндекс.Музыки вы сравните поведение пользователей двух столиц. Проверьте три гипотезы:
